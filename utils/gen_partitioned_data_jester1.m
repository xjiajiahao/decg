function gen_partitioned_data_jester1(num_agents)
% data_cell[i][j] is a n_j-by-2 matrix representing the ratings of agent i's jth user

%% initialization
ROOT = '../data/';
load([ROOT, 'Jester1.mat']);  % user_ratings_cell, user_ratings_matrix
...
filename = [ROOT, 'Jester1_', num2str(num_agents), '_agents.mat'];
