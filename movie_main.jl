...
# res_DeFW = DeFW(dim, data_cell, num_agents, weights, LMO, f_extension_batch, gradient_extension_batch, num_iters, alpha);
# res_DESAGAFW = DeSAGAFW(dim, data_cell, num_agents, weights, LMO, f_extension_batch, gradient_extension_batch, num_iters);
