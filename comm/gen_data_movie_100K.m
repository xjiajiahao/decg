function [user_ratings_cell, user_ratings_matrix] = gen_data_movielens_1M()
%% initialization
ROOT = '../data/';
num_movies = 1682;
num_users = 943;
...
f_movies = fopen([ROOT, 'items_100K.dat'], 'r');
counter = 0;
...
f_ratings= fopen([ROOT, 'movies_100K.dat'], 'r');
