function [user_ratings_cell, user_ratings_matrix, movie_genre] = gen_data_movielens_1M()
%% initialization
ROOT = '../data/';
num_movies = 3883;
num_users = 6040;
...
f_movies = fopen('data/movies.dat', 'r');
counter = 0;
...
f_ratings= fopen('data/ratings.dat', 'r');
